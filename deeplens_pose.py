	...
	while doInfer:
		...
		cv2.putText(frame, str(int(per*100))+"%", (20,400), cv2.FONT_HERSHEY_SIMPLEX, 5,color, 3)
	    	...
	    	for pair in POSE_PAIRS:
	    		...
	    		cv2.line(frame, (features[partA][0]*scale+offset,features[partA][1]*scale), (features[partB][0]*scale+offset,features[partB][1]*scale), (255, 179, 179), 3)
                for i in range(15):
                    cv2.circle(frame, (features[i][0]*scale+offset,features[i][1]*scale), 4, (26,101,26), thickness=-1)
